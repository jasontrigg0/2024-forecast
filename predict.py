...
def calculate_manifold_markets(all_simulations, manifold_info):
    ...
    market_conditions = {
        ...
        "Will Pennsylvania decide the election [read description]?": lambda x: abs(round(x["ec_margin"])) <= 2*ELECTORAL_COLLEGE_INFO["Pennsylvania"]["ev"] and (x["ec_margin"] * x["ec_results"]["Pennsylvania"]) > 0,
